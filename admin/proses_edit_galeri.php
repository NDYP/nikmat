...
if (empty($lokasi_file)) {
	$query = "UPDATE tbl_galeri SET nama_menu ='$nama_menu',  tanggal='$tanggal',harga='$harga' WHERE id_menu = '$id_menu'";
} else {
	move_uploaded_file($lokasi_file, 'image/galeri/' . $nama_file);
	$query = "UPDATE tbl_galeri SET  nama_menu ='$nama_menu', tanggal='$tanggal',harga='$harga', foto_menu='$nama_file' WHERE id_menu='$id_menu'";
}
