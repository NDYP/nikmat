                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-8">
                                    ...
                                    <form role="form" action="proses_edit_kontak.php" method="POST">
                                        <input type="hidden" name="id_kontak" value="<?php echo $isi['id_kontak']; ?>"/>                                 
                                       
 <div class="form-group">
                                         
                                            <textarea name="isi_kontak" class="ckeditor" required="required"><?php echo $isi['isi_kontak']; ?></textarea>
                                        </div>
                                       
                                            
                                        <button type="submit" class="btn btn-primary">Simpan</button>
                                        <button type="reset" class="btn btn-danger" onclick="var x = window.location ='kelola_kontak.php'">Batal</button>
                                    </form>
                                </div>
                                <!-- /.col-lg-6 (nested) -->
