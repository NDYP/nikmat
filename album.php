            ...
            <section class="gallery-area section-gap">
                <div class="container">
                    ...
                    <div class="col-lg-4">
                        ...
                        <center><a href="album_2.php?id=<?php echo $data['id_album']?>"><img class="img-fluid" src="admin/image/album/<?php echo $data['cover']; ?>" style="width: 250px; height: 250px;" alt="img"></a></center>

                        <center><h2 class="blog_title"><a href="album_2.php?id=<?php echo $data['id_album']?>" style="font-size: 15px;">
                            <?php echo $data['nama_album']?></a></h2></center>
