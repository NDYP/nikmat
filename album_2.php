            ...
            <!-- End banner Area -->    
             ...
             <section class="gallery-area section-gap">
                ...
                <div class="row">
                    ...
                    <?php 
                    $sql=mysql_query("SELECT tbl_album.*, tbl_galeri.* FROM tbl_album LEFT JOIN tbl_galeri ON tbl_album.`id_album` = tbl_galeri.`id_album` GROUP BY tbl_album.`id_album` limit $eu, $limit");
                    while ($data = mysql_fetch_array($sql)) {
                    ?>

                    <div class="col-lg-4">
                        
                        <center><a href="admin/image/galeri/<?php echo $data['galeri_gambar']?>"><img class="img-fluid" src="admin/image/galeri/<?php echo $data['galeri_gambar']; ?>" style="width: 250px; height: 250px;" alt="img"></a></center>

                        <center><h2 class="blog_title"><a href="admin/image/galeri/<?php echo $data['galeri_gambar']?>" style="font-size: 15px;">
                            <?php echo $data['galeri_judul']?></a></h2></center>
